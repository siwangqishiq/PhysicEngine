...
void init()
{
    ...
    psA = particleForceGenFakeSpringCreate(0,0,1,0.5f);
    //psB = particleForceGenFakeSpringCreate(-100,0, 0.01f, 100);
...
//    particleForceGenBungeeSpringFree(psA);
//    particleForceGenBungeeSpringFree(psB);
    particleForceGenFakeSpringFree(psA);
}